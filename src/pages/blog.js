    ...
    return (
        <Layout>
            <div className="w3-container w3-center w3-padding-16">
                <h5 className><span className="w3-tag w3-theme w3-wide">MY BLOG</span></h5>
            </div>
            ...
            <div className="w3-container w3-margin-bottom" style={{opacity: 0}}>
                <div className="w3-content w3-card-2 w3-padding-18" style={{ maxWidth: "750px" }}>
                    <div className="w3-container">
                        ...
                        <p></p>
                        <p><Link to="" className="w3-button w3-padding-large w3-border w3-border-theme"><b>READ MORE >></b></Link></p>
                    </div>
                </div>
            </div>
        </Layout>
